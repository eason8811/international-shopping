...
public class ProductSkuUpsertItemCommand {
     ...
     */
    @Nullable
    private final List<ProductPriceUpsertCommand> priceList;
    /**
     * 规格绑定列表
     */
    ...
    private ProductSkuUpsertItemCommand(@Nullable Long id,
                                        ...
                                        @Nullable List<ProductPriceUpsertCommand> priceList,
    ...
    public static ProductSkuUpsertItemCommand of(@Nullable Long id,
                                                 ...
                                                 boolean isDefault,
                                                 @Nullable String barcode,
                                                 @Nullable List<ProductPriceUpsertCommand> price,
        ...
        List<ProductPriceUpsertCommand> safePrices = price == null ? List.of() : List.copyOf(price);
        return new ProductSkuUpsertItemCommand(id, skuCode, stock, weight, status, isDefault, barcode, safePrices, safeSpecs, safeImages);
    }
}
