...
class CategoryServiceTest {
    ...
    void createShouldValidateUniquenessAndBuildPath() {
        ...
        Category category = categoryService.create(" Name ", " slug ", null, 0, "https://oss.example.com/category/slug.jpg", true,
                List.of(CategoryI18n.of("en-US", "Name", "slug", null)));

        assertSame(saved, category);
        verify(categoryRepository).save(Mockito.argThat(c -> c.getPath() == null
                && c.getLevel() == 1
                && "https://oss.example.com/category/slug.jpg".equals(c.getCover())));
    }

    @Test
    void updateShouldMoveNodeAndReplaceI18n() {
        Category current = Category.reconstitute(2L, 1L, "Child", "child", 2, "/1/", 0, CategoryStatus.ENABLED,
                "https://oss.example.com/category/child.jpg", null, List.of(CategoryI18n.of("en-US", "Child", "child", null)), null, null);
        Category parent = Category.reconstitute(3L, null, "Parent", "parent", 1, "/", 0, CategoryStatus.ENABLED, null, null, List.of(), null, null);
        Category updated = Category.reconstitute(2L, 3L, "Child-Updated", "child-updated", 2, "/3/", 5, CategoryStatus.DISABLED, "https://oss.example.com/category/child-updated.jpg", null,
        ...
        Category result = categoryService.update(2L, "Child-Updated", "child-updated", 3L, 5, "https://oss.example.com/category/child-updated.jpg", false,
        ...
        assertEquals("https://oss.example.com/category/child-updated.jpg", result.getCover());
